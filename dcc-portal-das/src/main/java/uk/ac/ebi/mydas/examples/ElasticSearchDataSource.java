...
public class ElasticSearchDataSource implements RangeHandlingAnnotationDataSource {
  // CacheManager cacheManager = null;
  ServletContext svCon;
  Map<String, PropertyType> globalParameters;
  DataSourceConfiguration config;
  ElasticSearchParser elasticSearch;
  ...
  public void init(ServletContext servletContext, Map<String, PropertyType> globalParameters,
    ...
    elasticSearch = new ElasticSearchParser();
  }
  ...
  public DasAnnotatedSegment getFeatures(String segmentId, Integer maxbins) throws BadReferenceObjectException,
      DataSourceException {
    try {
  ...
  public Integer getTotalCountForType(DasType type) throws DataSourceException {
    return elasticSearch.getTotalCountForType(type.getId());// Add a method in ElasticSearchParser
                                                            // to get total count for any type
  }

  /*
   * public void registerCacheManager(CacheManager cacheManager) { this.cacheManager = cacheManager;
   * }
   */
  ...
  @Override
  public DasAnnotatedSegment getFeatures(String featureId, int start, int stop, Integer maxbins, Range rows)
      throws UnimplementedFeatureException, DataSourceException {
    throw new UnimplementedFeatureException("Not implemented");
  }
}
