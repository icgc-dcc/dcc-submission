...
(function () {
  ...
  Ua = function (a, b, c) {
    ...
    var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b), e, f = d[lb](), g = d[nb](), h = d[Qa](), i = d[Xa](), j = d[Ya](), k = P.lang, m = k.weekdays, d = u({a: m[g].substr(0, 3), A: m[g], d: va(h), e: h, b: k.shortMonths[i], B: k.months[i],
      m: va(i + 1), y: j.toString().substr(2, 2), Y: j, H: va(f), I: va(f % 12 || 12), l: f % 12 || 12, M: va(d[kb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: va(d.getSeconds()), L: va(t(b % 1E3), 3)}, Highcharts.dateFormats);
    for (e in d)for (; a.indexOf("%" + e) !== -1;)a = a.replace("%" + e, typeof d[e] === "function" ? d[e](b) : d[e]);
    return c ? a.substr(0, 1).toUpperCase() + a.substr(1) : a
  };
  Fb.prototype = {wrapColor: function (a) {
  ...
  var gb = L.adapterRun, Sb = L.getScript, ka = L.inArray, n = L.each, Ob =
      L.grep, Tb = L.offset, Ka = L.map, J = L.addEvent, ba = L.removeEvent, G = L.fireEvent, Pb = L.washMouseEvent, vb = L.animate, Ta = L.stop, L = {enabled: !0, align: "center", x: 0, y: 15, style: {color: "#666", cursor: "default", fontSize: "11px", lineHeight: "14px"}};
  P = {colors: "#2f7ed8,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","),
    ...
    showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {enabled: !0, lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: x(L, {enabled: !1, formatter: function () {
      return this.y
    }, verticalAlign: "bottom", y: 0}), cropThreshold: 300, pointRange: 0, showInLegend: !0, states: {hover: {marker: {}}, select: {marker: {}}}, stickyTracking: !0}}, labels: {style: {position: "absolute", color: "#3E576F"}}, legend: {enabled: !0,
  ...
  ra.prototype = {init: function (a, b) {
    ...
    if (fa(a))c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), r = C(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (r = parseFloat(r)); else {
      for (c in a)if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
        ...
        } else if (c === "width")d = v(d); else if (c === "align")c = "text-anchor", d = {left: "start", center: "middle",
    ...
    css: function (a) {
      ...
      if (this.added) {
        ...
        if (b.tagName === "SPAN") {
          ...
          if (I !== this.cTT) {
            ...
            if (k > l && /[ \-]/.test(b.textContent || b.innerText))M(b, {width: l + "px", display: "block", whiteSpace: "normal"}), k = l;
      ...
      if (a) {
        ...
        for (e = 1; e <= i; e++) {
          f = g.cloneNode(0);
          h = i * 2 + 1 - 2 * e;
          C(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: O});
          if (c)C(f,
  ...
  Ba.prototype = {Element: ra, init: function (a, b, c, d) {
    var e = location, f;
    ...
    }, j = a.match(i)[1], a = Lb[j], g = this.image(j).attr({x: b, y: c}), a ? k(g, a) : (g.attr({width: 0, height: 0}), U("img", {onload: function () {
      ...
      if (a) {
        if (b = a.div, !b) {
          ...
          n(d.reverse(), function (a) {
            var d;
            b = a.div = a.div || U(xa, {className: C(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
            d = b.style;
            u(a.attrSetters,
  ...
  if (!Z && !$) {
    Highcharts.VMLElement = K = {init: function (a, b) {
      ...
      if (fa(a))c = a, r = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
        ...
        if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))k || (this.symbolAttr(a), k = !0), l = !0; else if (c === "d") {
          ...
          g[c] = d;
          l = !0
        } else if (c === "zIndex")d && (g[c] = d), l = !0; else if (ka(c, ["x", "y", "width", "height"]) !== -1)this[c] = d, c === "x" || c === "y" ? c = {x: "left",
    ...
    K = ea(ra, K);
    var ma = {Element: K, isIE8: za.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
      var d, e;
      this.alignedObjects = [];
      ...
      isHidden: function () {
        ...
        return u(e, {members: [], left: f ? a.x : a, top: f ? a.y : b, width: f ? a.width : c, height: f ? a.height : d, getCSS: function (a) {
  ...
  Ia.prototype = {addLabel: function () {
    ...
    if (l && y)s === "inside" && (y = -y), d.opposite && (y = -y), b = this.getMarkPath(H, Q, y, l * D, g, f), p ? p.animate({d: b, opacity: c}) : this.mark = f.path(b).attr({stroke: q, "stroke-width": l, opacity: c}).add(d.axisGroup);
  ...
  Ib.prototype = {destroy: function () {
    ...
    var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ? 100 : this.total,
        0, 0, 0, 1), c = c.translate(0), c = R(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
  ...
  ab.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1,
    ...
    showLastLabel: !0, labels: {align: "right", x: -8, y: 3}, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
      return this.total
    }, style: L.style}}, defaultLeftAxisOptions: {labels: {align: "right", x: -8, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {align: "left", x: 8, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {align: "center", x: 0, y: 14}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {align: "center",
    ...
    getThreshold: function (a) {
      ...
      var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = v(e.style.fontSize || 12), d = {low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0)}[e.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin + (this.side === 2 ? i : 0);
      ...
      if (a.hasData || f)if (n([j, k, m], function (a) {
        ...
        if (c % 2 === 0 && b < a.max)m[b] || (m[b] = new ob(a)), u = b + r, v = g[c + 1] !== w ? g[c + 1] + r : a.max, m[b].options = {from: e ? da(u) : u, to: e ? da(v) : v, color: p}, m[b].render(), m[b].isActive = !0
      ...
      if (o)B = a.getLinePath(o), a.axisLine ? a.axisLine.animate({d: B}) : a.axisLine = c.path(B).attr({stroke: d.lineColor, "stroke-width": o, zIndex: 7}).add(a.axisGroup), a.axisLine[t ? "show" : "hide"]();
  ...
  pb.prototype = {init: function (a, b) {
    ...
    if (l) {
      l = ha(l);
      for (d = l.length; d--;)if (e = a.series[d ? "yAxis" : "xAxis"], l[d] && e)if (e = e.getPlotLinePath(d ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[d])this.crosshairs[d].attr({d: e,
  ...
  qb.prototype = {init: function (a, b) {
    ...
    if (this.hasDragged >
      ...
      this.selectionMarker && e && (e = d - m, this.selectionMarker.attr({width: R(e), x: (e > 0 ? 0 : e) + m}));
      this.selectionMarker && f && (e = a - l, this.selectionMarker.attr({height: R(e), y: (e > 0 ? 0 : e) + l}));
    ...
    if (this.selectionMarker) {
      ...
      if (this.hasDragged || c)n(b.axes, function (a) {
        if (a.zoomEnabled) {
          ...
          !isNaN(m) && !isNaN(b) && (d[a.xOrY + "Axis"].push({axis: a, min: F(m, b), max: q(m, b)}), h = !0)
        }
    ...
    a.cancelBubble = !0;
    if (!b.cancelClick)c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, u(c, {pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i)}), G(c.series, "click", u(a, {point: c})), c.firePointEvent("click",
  ...
  rb.prototype = {init: function (a, b) {
    ...
    if (b)c = b.translateY, n(this.allItems,
        function (e) {
          var f = e.checkbox, g;
          f && (g = c + f.y + (a || 0) + 3, M(f, {left: b.translateX + e.legendItemWidth + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : O}))
        })
    ...
    if (!n && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = n = d.text(e.labelFormat ? Ea(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ?
        i : j)).attr({align: m ? "left" : "right", zIndex: 2}).add(a.legendGroup), (v ? n : a.legendGroup).on("mouseover",function () {
      a.setState("hover");
    ...
    }), b.colorizeItem(a, a.visible), s && u))a.checkbox = U("input", {type: "checkbox", checked: a.selected, defaultChecked: a.selected},
    ...
    if (m || l) {
      ...
      } else a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m || 0, fill: l || O}).add(d).shadow(j.shadow), i.isNew = !0;
      i[f ? "show" : "hide"]()
    }
    a.legendWidth = g;
    a.legendHeight = h;
    ...
    d > c && (d = c);
    if (d > 0)b !== w && Ha(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: d ===
        1 ? h : g}).css({cursor: d === 1 ? "default" : "pointer"}), f.attr({text: d + "/" + this.pageCount}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: d === c ? h : g}).css({cursor: d === c ? "default" : "pointer"}), e = -F(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({translateY: e}), f.attr({text: d + "/" + c}), this.currentPage = d, this.positionCheckboxes(e)
  }};
  sb.prototype = {init: function (a, b) {
    ...
    isInsidePlot: function (a, b, c) {
      ...
      if (!c)this.loadingDiv = c = U(xa, {className: "highcharts-loading"}, u(d.style, {left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px", zIndex: 10, display: O}), this.container), this.loadingSpan = U("span", null, d.labelStyle, c);
      this.loadingSpan.innerHTML =
          a || b.lang.loading;
      if (!this.loadingShown)M(c, {opacity: 0, display: ""}), vb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
      ...
      c = this.chartWidth;
      d = this.chartHeight;
      this.container = a = U(xa, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, u({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0}, b.style), this.renderToClone || a);
  ...
  Ma.prototype = {init: function (a, b, c) {
    this.series = a;
  ...
  S.prototype = {isCartesian: !0, type: "line", pointClass: Ma, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function (a, b) {
    var c, d, e = a.series;
    this.chart = a;
    this.options = b = this.setOptions(b);
    this.bindAxes();
    u(this, {name: b.name, state: "", pointAttr: {}, visible: b.visible !== !1, selected: b.selected === !0});
    if ($)b.animation = !1;
    d = b.events;
    ...
    var a = this, b = a.options, c = X[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = {stroke: g, fill: g}, i = a.points || [], j = [], k, m = a.pointAttrToOptions, l = b.negativeColor, o;
    ...
    var f =
        this.chart, g = f.inverted, h = o(a.plotX, -999), a = o(a.plotY, -999), i = b.getBBox(), d = u({x: g ? f.plotWidth - a : h, y: t(g ? f.plotHeight - h : a), width: 0, height: 0}, d);
    ...
    if (j)j.attr({d: d}); else if (a.tracker = j = h.path(d).attr({"class": "highcharts-tracker", "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: Mb,
      fill: c ? Mb : O, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).addClass("highcharts-tracker").on("mouseover", n).on("mouseout",function (a) {
  ...
  L = ea(S, {type: "area", getSegments: function () {
    ...
    if (this.options.stacking && !this.cropped) {
      ...
      for (f in b)c[f] ? a.push(c[f]) : (d = this.xAxis.translate(f),
          e = this.yAxis.toPixels(b[f].cum, !0), a.push({y: null, plotX: d, clientX: d, plotY: e, yBottom: e, onMouseOver: ta}));
      a = [a]
    ...
    n(d, function (d) {
      var f = d[0], g = a[f];
      g ? g.animate({d: b}) : a[f] = a.chart.renderer.path(b).attr({fill: o(d[2], la(d[1]).setOpacity(c.fillOpacity ||
  ...
  aa.area = L;
  X.spline = x(W);
  K = ea(S, {type: "spline", getPointSpline: function (a, b, c) {
  ...
  ma = L.prototype;
  K = ea(K, {type: "areaspline", closedStacks: !0, getSegmentPath: ma.getSegmentPath, closeSegment: ma.closeSegment, drawGraph: ma.drawGraph});
  aa.areaspline = K;
  X.column = x(W, {borderColor: "#FFFFFF", borderWidth: 1, borderRadius: 0, groupPadding: 0.2,
  ...
  K = ea(S, {type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, trackerGroups: ["group", "dataLabelsGroup"], init: function () {
    ...
    if (h && (d = x(h), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight -
        d.x - d.width, width: d.height, height: d.width}), !j))g ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0, d.height = 0);
  ...
  aa.bar = ma;
  X.scatter = x(W, {lineWidth: 0, tooltip: {headerFormat: '<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>",
    followPointer: !0}, stickyTracking: !1});
  ma = ea(S, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup"], drawTracker: K.prototype.drawTracker, setTooltipPoints: ta});
  aa.scatter = ma;
  X.pie = x(W, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function () {
    return this.point.name
  }}, ignoreHiddenPoint: !0, legendType: "point", marker: null, size: null, showInLegend: !1, slicedOffset: 10, states: {hover: {brightness: 0.1, shadow: !1}},
    stickyTracking: !1, tooltip: {followPointer: !0}});
  W = {type: "pie", isCartesian: !1, pointClass: ea(Ma, {init: function () {
    ...
    "dataLabelsGroup"], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, getColor: ta, animate: function (a) {
    ...
    var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector,
        !0), m = e.distance, l = a.center, p = l[2] / 2, r = l[1], s = m > 0, u, v, w, x, C = [
      [],
      []
    ], z, A, G, H, D, F = [0, 0, 0, 0], L = function (a, b) {
      return b.y - a.y
    }, M = function (a, b) {
      a.sort(function (a, c) {
  ...
  }, alignDataLabel: ta, drawTracker: K.prototype.drawTracker,
    drawLegendSymbol: L.prototype.drawLegendSymbol, getSymbol: ta};
  W = ea(S, W);
  aa.pie = W;
  u(Highcharts, {Axis: ab, Chart: sb, Color: la, Legend: rb, Pointer: qb, Point: Ma, Tick: Ia, Tooltip: pb, Renderer: Sa, Series: S, SVGElement: ra, SVGRenderer: Ba, arrayMin: Fa, arrayMax: pa, charts: Aa, dateFormat: Ua, format: Ea, pathAnim: ub, getOptions: function () {
    return P
  }, hasBidiBug: Rb, isTouchDevice: Kb, numberFormat: Na, seriesTypes: aa, setOptions: function (a) {
    P = x(P, a);
    Hb();
    return P
  }, addEvent: J, removeEvent: ba, createElement: U, discardElement: Ra, css: M, each: n,
    extend: u, map: Ka, merge: x, pick: o, splat: ha, extendClass: ea, pInt: v, wrap: function (a, b, c) {
      var d = a[b];
      a[b] = function () {
    ...
    }, svg: Z, canvas: $, vml: !Z && !$, product: "Highcharts", version: "3.0.0"})
})();
